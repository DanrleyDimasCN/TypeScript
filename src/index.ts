...
// tipos básicos
let firstName: string = "Danrley Dimas"
let age: number = 26
...
// any EVITAR USAR, É VISTO COMO MÁ PRÁTICA, PORQUE PERDE A FUNCIONALIDADE DO TYPESCRIPT.
let a: any = 0;
...
console.log(sayHelloTo("Danrley Dimas"));
